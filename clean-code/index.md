...
Примеры внутри глав часто показывают фрагмент приложения: типы, импорты или API проекта могут задаваться окружающим кодом. Перед переносом проверьте зависимости, обработку ошибок и требования своего задания.
