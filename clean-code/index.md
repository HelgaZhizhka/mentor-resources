...
1. **Сначала откройте задание.** Его критерии, разрешённые инструменты и ограничения определяют обязательные требования. Этапы ревью, сроки и порядок оценки задаёт [документация школы](https://github.com/rolling-scopes-school/docs/blob/master/docs/ru/mentoring/pull-request-review-process.md).
